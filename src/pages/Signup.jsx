    ...
    <div className="auth-page-wrapper">
      ...
      <div className="auth-card-container split-card">
        ...
        <div className="auth-right-form">
          <div className="auth-badge" style={{ display: "none" }}>Mya Signup</div>
          <h1 className="auth-card-title">Đăng ký tài khoản</h1>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column" }}>
            ...
            <button type="submit" className="auth-btn-black" style={{ marginTop: "12px" }} disabled={isSigningUp}>
              {isSigningUp ? (
          ...
          <div className="auth-social-section">
            <span className="auth-social-title">Hoặc đăng ký bằng</span>
            <div className="auth-social-icons">
              ...
              <button 
                ...
                onClick={() => alert("Đăng ký bằng Google chưa được cấu hình!")}
              >
              ...
              <button 
                ...
                onClick={() => alert("Đăng ký bằng Facebook chưa được cấu hình!")}
              >
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <button 
                ...
                title="Đăng ký bằng Discord"
                onClick={() => alert("Đăng ký bằng Discord chưa được cấu hình!")}
              >
